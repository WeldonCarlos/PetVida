    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white  "  style=" height: 30px; align-items: center; margin-top:40px; " >
        <div class="container-fluid " style=" margin: 0 10px 0 10px ">
            ...
            <div class="collapse navbar-collapse  justify-content-end "    id="navbarSupportedContent">
                ...
                <ul class="navbar-nav  mb-2 mb-lg-0 "  style=" color:#f2f2f2; font-family: Ubuntu, sans-serif; font-weight: 500;
        font-style: normal; font-size: 20px; "> 
                    <li class="nav-item">
                        <a class="nav-link active"  style="color: #94cf1c;" aria-current="page" href="index.php?page=home">Home</a>
                    </li>
                    <li class="nav-item">
